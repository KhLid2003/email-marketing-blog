        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-indigo max-w-none">
            <p className="text-xl text-gray-600 mb-8">
              EmailPro is your ultimate resource for mastering email marketing.
              We provide expert insights, strategies, and best practices to help
              you create successful email campaigns that drive results.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">
                  Learn from industry experts about proven email marketing
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">
                  Stay updated with the latest email marketing best practices
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">
                  Access insights from successful email marketing campaigns
                  worldwide.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">
                  Learn how to leverage analytics to optimize your email
            ...
            <div className="bg-indigo-50 p-8 rounded-xl mb-12">
              ...
              <p className="text-gray-600 mb-4">
                We believe in empowering marketers with the knowledge and tools
                they need to create impactful email marketing campaigns that
                drive engagement and conversions.
              </p>
              <p className="text-gray-600">
                Our platform is designed to help you stay ahead of the curve
                with the latest trends, technologies, and strategies in email
                marketing.
              </p>
            </div>
